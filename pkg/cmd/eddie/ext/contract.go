...
// A ContractProvider can construct new instances of a Contract.
type ContractProvider struct {
	Help string
	New  func() Contract
}

// ContractProviders defines a lookup map of providers.
type ContractProviders map[string]*ContractProvider
